...
\restrict UM3fqkOA2x1hsHBQZccphZPlaB2g5SWJhxNVOKDVmfWIqwj7uHdeRB7pycbBYKc
...
--
-- Name: permissoes_per_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: permissoes_per_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: usuario_permissoes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: usuario_permissoes_usu_per_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: permissoes per_id; Type: DEFAULT; Schema: public; Owner: -
--
...
25	12	2026-03-03	09:00:00	1		\N	1	e1d5e7de-6c1f-4387-8992-afc666e09db3
...
COPY public.permissoes (per_id, per_chave, per_descricao) FROM stdin;
1	usuarios.listar	Visualizar lista de usuários
2	usuarios.visualizar	Visualizar detalhes do usuário
3	usuarios.criar	Criar novo usuário
4	usuarios.editar	Editar usuário
7	usuarios.alterar_status	Alterar status do usuário
8	usuarios.veiculos	Visualizar veículos do usuário
9	veiculos.listar	Visualizar lista de veículos
10	veiculos.visualizar	Visualizar detalhes do veículo
11	veiculos.criar	Cadastrar novo veículo
12	veiculos.editar	Editar veículo
14	servicos.listar	Visualizar lista de serviços
15	servicos.visualizar	Visualizar detalhes do serviço
16	servicos.criar	Cadastrar novo serviço
17	servicos.editar	Editar serviço
26	permissoes.listar	Visualizar lista de todas as permissões do sistema
27	permissoes.visualizar	Visualizar quais permissões um usuário possui
28	permissoes.editar	Alterar as permissões de um usuário
23	agendamentos.cancelar	Cancelar agendamento
20	agendamentos.visualizar	Visualizar detalhes do agendamento
22	agendamentos.editar	Editar agendamento
21	agendamentos.criar	Criar agendamento
19	agendamentos.listar	Visualizar agendamentos
31	financeiro.visualizar_statCard	Visualizar Card de status financeiro
35	servicos.alterar_status	Alterar status do serviço
13	veiculos.alterar_status	Alterar status do veículo
36	veiculos_usuario.listar	Listar veículos do usuário
37	veiculos_usuario.criar	Criar vínculo entre veículo e usuário
38	veiculos_usuario.editar	Editar vínculo entre veículo e usuário
39	veiculos_usuario.excluir	Excluir vínculo entre veículo e usuário
40	veiculos_usuario.visualizar	Exibir vínculo entre veículo e usuário
\.
...
52	1	Lavagem Comercial	Teste da Lavegem 121	t
51	10	serviço teste mota 2	troquei a descrição	t
56	9	Reparo de Retrovisor	Serviço criado pelo 121	t
57	1	serviço teste permissões	teste descrição	t
...
19	52	2	170.00	01:30:00	t
20	52	4	190.00	02:00:00	t
21	51	2	20.00	01:00:00	t
22	56	3	110.00	00:20:00	t
24	57	1	120.00	01:00:00	t
\.
...
--
-- Data for Name: usuario_permissoes; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.usuario_permissoes (usu_per_id, usu_id, per_id) FROM stdin;
1286	85	1
1287	85	2
1288	85	3
1289	85	4
...
121	Nei Junio Nogueira	163.795.470-02	1990-10-10	0	(18) 96465-5656	neijunionogueira@email.com		t	$2b$10$9smdfddG9L2sSodP8rmvPe8Jahdr7FboID3wjgO/c2lAbFyg6r8b2	t	\N	\N
...
114	Nei Junio Nogueira Gomes	631.648.970-65	2003-11-17	0	(18) 99455-9595	neijunio50@gmail.com	\N	t	$2b$10$6QupQIyqhJzfI4YWu/RRqeagyKI.CptYokMkLUWPitjYcLvJsqxYa	t	\N	\N
127	Bruno Falconatto	679.084.530-58	1992-06-06	0	(14) 94948-4909	bruno.falconatto@gmail.com	Usuário criado através do usuário 121 teste 2	f	$2b$10$fzqZva7NsCOC49rC0SlL9OAUm6KsGGJ6Psx5kqc8QYOFNmQtAoibi	t	\N	\N
\.
...
22	15	121	t	2026-03-03	\N
23	14	127	t	2026-03-07	\N
25	12	113	t	2026-03-07	\N
14	10	113	t	2026-01-06	2026-03-07
\.
...
8	1559	ROG-2043	2021	Marrom	GASOLINA	Descrição I	f
14	2445	DDB-2342	2010	Amarelo	GASOLINA	Veículo criado pelo 121	t
15	3625	AFD-5454	1990	Preto	FLEX	teste 2	f
\.
...
SELECT pg_catalog.setval('public.agenda_servicos_agend_serv_id_seq', 74, true);
...
SELECT pg_catalog.setval('public.agendamentos_agend_id_seq', 25, true);
...
--
-- Name: permissoes_per_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.permissoes_per_id_seq', 40, true);
...
SELECT pg_catalog.setval('public.servicos_serv_id_seq', 57, true);
...
SELECT pg_catalog.setval('public.servicos_tipo_veiculo_stv_id_seq', 24, true);
...
--
-- Name: usuario_permissoes_usu_per_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.usuario_permissoes_usu_per_id_seq', 1315, true);
...
SELECT pg_catalog.setval('public.usuarios_usu_id_seq', 127, true);
...
SELECT pg_catalog.setval('public.veiculo_usuario_veic_usu_id_seq', 25, true);
...
SELECT pg_catalog.setval('public.veiculos_veic_id_seq', 15, true);
...
--
-- Name: permissoes permissoes_per_chave_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: usuario_permissoes usuario_permissoes_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: usuario_permissoes fk_permissao; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: usuario_permissoes fk_usuario; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict UM3fqkOA2x1hsHBQZccphZPlaB2g5SWJhxNVOKDVmfWIqwj7uHdeRB7pycbBYKc
