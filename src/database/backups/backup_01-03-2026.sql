...
\restrict eDJZF6J1QcydXrrfhFPj5wqawtt4OCNdht70o3Ti00ojHUbGC4ZWWRtk2489ZmP

-- Dumped from database version 17.8 (6108b59)
-- Dumped by pg_dump version 17.7

-- Started on 2026-03-01 14:54:37
...
--
-- TOC entry 3558 (class 1262 OID 16391)
...
\unrestrict eDJZF6J1QcydXrrfhFPj5wqawtt4OCNdht70o3Ti00ojHUbGC4ZWWRtk2489ZmP
\connect neondb
\restrict eDJZF6J1QcydXrrfhFPj5wqawtt4OCNdht70o3Ti00ojHUbGC4ZWWRtk2489ZmP
...
--
-- TOC entry 3544 (class 0 OID 24706)
-- Dependencies: 242
...
--
-- TOC entry 3538 (class 0 OID 24667)
-- Dependencies: 236
...
--
-- TOC entry 3536 (class 0 OID 24654)
-- Dependencies: 234
...
--
-- TOC entry 3522 (class 0 OID 24577)
-- Dependencies: 220
...
--
-- TOC entry 3540 (class 0 OID 24686)
-- Dependencies: 238
...
--
-- TOC entry 3524 (class 0 OID 24584)
-- Dependencies: 222
...
--
-- TOC entry 3526 (class 0 OID 24592)
-- Dependencies: 224
...
--
-- TOC entry 3528 (class 0 OID 24600)
-- Dependencies: 226
...
--
-- TOC entry 3530 (class 0 OID 24612)
-- Dependencies: 228
...
--
-- TOC entry 3550 (class 0 OID 106506)
-- Dependencies: 248
...
5	usuarios.inativar	Inativar usuário
6	usuarios.reativar	Reativar usuário
...
13	veiculos.inativar	Inativar veículo
...
18	servicos.inativar	Inativar serviço
24	historico.listar	Visualizar histórico
25	historico.visualizar	Visualizar detalhes do histórico
...
29	veiculos.reativar	Reativar veículo
...
30	calendario.visualizar	Visualizar Calendário (Agenda)
19	agendamentos.listar	Visualizar agendamentos
\.


--
-- TOC entry 3542 (class 0 OID 24693)
-- Dependencies: 240
...
--
-- TOC entry 3548 (class 0 OID 73737)
-- Dependencies: 246
...
--
-- TOC entry 3546 (class 0 OID 73729)
-- Dependencies: 244
...
--
-- TOC entry 3552 (class 0 OID 114703)
-- Dependencies: 250
-- Data for Name: usuario_permissoes; Type: TABLE DATA; Schema: public; Owner: neondb_owner
--
...
--
-- TOC entry 3520 (class 0 OID 16488)
-- Dependencies: 218
...
121	Nei Junio Nogueira	163.795.470-02	1990-10-10	0	(18) 96465-5656	neijunionogueira@email.com	\N	t	$2b$10$RfjD7rxGZL35xF.Z3vnWAeHWvwUIoAQhrucaEcs5YIQPKtGWk8MJW	t	\N	\N
\.


--
-- TOC entry 3534 (class 0 OID 24637)
-- Dependencies: 232
...
--
-- TOC entry 3532 (class 0 OID 24624)
-- Dependencies: 230
...
-- Dependencies: 247
-- Name: permissoes_per_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.permissoes_per_id_seq', 30, true);
...
-- Dependencies: 249
-- Name: usuario_permissoes_usu_per_id_seq; Type: SEQUENCE SET; Schema: public; Owner: neondb_owner
--

SELECT pg_catalog.setval('public.usuario_permissoes_usu_per_id_seq', 170, true);
...
SELECT pg_catalog.setval('public.usuarios_usu_id_seq', 126, true);
...
-- Completed on 2026-03-01 14:55:04
